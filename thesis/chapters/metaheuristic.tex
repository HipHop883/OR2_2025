...
This trade-off is analyzed experimentally in Section~\ref{sec:results}.\todo{trade off analysis nella sezione dei rsiultati}
...
\todo{Vedere se è ancora coerente con la nuova implementazione}
