...
Figure \ref{fig:hf-profiles-30sec} compares the three fixing ratios with the local time limit held constant at 30 ssecond. It confirms that constraining the arcs too tightly degrades performance, whereas the 70\% fixing level still achieves the highest coverage across those tested.
